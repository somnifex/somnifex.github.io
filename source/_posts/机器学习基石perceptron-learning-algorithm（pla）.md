...
![截屏2020-02-27下午7.33.11](https://i.096899.xyz/16311025992946.png)
我们使用$w_i(i=0)$作为初始的线
循环下面操作：
...
* 用错误的线做内积运算
  ...
  >
* 进行修正
  ![这里写图片描述](https://i.096899.xyz/16311025992961.png)
  ...
  ![这里写图片描述](https://i.096899.xyz/16311025992976.png)
  下面用图解的形式来介绍PLA的修正过程：
  红线代表$w^T$表示分割线$w$的法线，正方向为法方向。
  ![这里写图片描述](https://i.096899.xyz/16311025992991.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993009.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993026.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993045.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993064.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993084.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993105.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993125.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993146.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993166.png)
  ![这里写图片描述](https://i.096899.xyz/16311025993185.png)
  问题：
* 这种方法一定会停下来吗？
* 假设停下来了,$g$是否等于$f$？
...
![这里写图片描述](https://i.096899.xyz/16311025993205.png)
对于线性可分的情况，如果有这样一条直线，能够将正类和负类完全分开，令这时候的目标权重为$w_f$，则对每个点，必然满足$y_n=sign(w_f^Tx_n)$，即对任一点：
![这里写图片描述](https://i.096899.xyz/16311025993225.png)
...
![这里写图片描述](https://i.096899.xyz/16311025993246.png)
...
![这里写图片描述](https://i.096899.xyz/16311025993270.png)
...
下面贴出来该结论的具体推导过程：
![这里写图片描述](https://i.096899.xyz/16311025993291.png)
![这里写图片描述](https://i.096899.xyz/16311025993312.png)
...
![这里写图片描述](https://i.096899.xyz/16311025993334.png)
对于非线性可分的情况，我们可以把它当成是数据集D中掺杂了一下noise，事实上，大多数情况下我们遇到的D，都或多或少地掺杂了noise。这时，机器学习流程是这样的：
![这里写图片描述](https://i.096899.xyz/16311025993357.png)
在非线性情况下，我们可以把条件放松，即不苛求每个点都分类正确，而是容忍有错误点，取错误点的个数最少时的权重w：
![这里写图片描述](https://i.096899.xyz/16311025993382.png)
...
![这里写图片描述](https://i.096899.xyz/16311025993407.png)
